# =============================================================================
# MODULE: IAM — Least-Privilege EC2 Role
# This role ONLY allows s3:GetObject on one specific bucket.
# It cannot list all buckets, access other buckets, or call any other AWS API.
# =============================================================================
...
data "aws_iam_policy_document" "s3_read_only" {
  ...
  # EXPLICIT DENY — overrides any accidental wildcard grants elsewhere
  statement {
